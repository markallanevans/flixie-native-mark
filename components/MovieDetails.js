...
class MovieDetails extends PureComponent {
  render() {
    ...
    const contents = [
      { title: 'Released: ', detail: params.release_date },
      { title: 'Popularity: ', detail: params.popularity.toFixed(0).toString() },
      { title: 'Score: ', detail: params.vote_average.toFixed(1).toString() },
    ];
